...
class UploadPhotoScreen extends StatelessWidget {
        ...
        child: SizedBox(
            ...
            child: Stack(alignment: Alignment.bottomRight, children: [
              ...
              CustomImageView(
                  ...
                  width: 53.h,
                  alignment: Alignment.bottomRight,
                  margin: EdgeInsets.only(right: 10.h, bottom: 79.v)),
              CustomImageView(
                  imagePath: ImageConstant.imgVector14x16,
                  height: 14.v,
                  width: 16.h,
                  alignment: Alignment.bottomRight,
                  margin: EdgeInsets.only(right: 36.h, bottom: 93.v)),
              CustomImageView(
                  imagePath: ImageConstant.imgVector8x6,
                  height: 8.v,
                  width: 6.h,
                  alignment: Alignment.bottomRight,
                  margin: EdgeInsets.only(right: 30.h, bottom: 107.v)),
              CustomImageView(
                  imagePath: ImageConstant.imgVector12x10,
                  height: 12.v,
                  width: 10.h,
                  alignment: Alignment.bottomRight,
                  margin: EdgeInsets.only(right: 45.h, bottom: 105.v)),
              CustomImageView(
              ...
              CustomImageView(
                  ...
                  width: 4.adaptSize,
                  alignment: Alignment.bottomRight,
                  margin: EdgeInsets.only(right: 42.h, bottom: 104.v)),
              CustomImageView(
              ...
              CustomImageView(
                  ...
                  width: 36.h,
                  alignment: Alignment.topRight,
                  margin: EdgeInsets.only(top: 84.v, right: 79.h)),
              CustomImageView(
                  imagePath: ImageConstant.imgVector16x13,
                  height: 16.v,
                  width: 13.h,
                  alignment: Alignment.topRight,
                  margin: EdgeInsets.only(top: 95.v, right: 94.h)),
              Align(
  ...
  Widget _buildGalleryButton(BuildContext context) {
    return Container(
        width: 325.h,
        padding: EdgeInsets.symmetric(horizontal: 119.h, vertical: 23.v),
        ...
        child: Column(
            ...
            children: [
              ...
              Text("From Gallery",
                  style: CustomTextStyles.titleSmallAbhayaLibreBlack90002),
              SizedBox(height: 2.v)
            ]));
  }
  ...
  Widget _buildCameraButton(BuildContext context) {
    return Container(
        width: 325.h,
        padding: EdgeInsets.symmetric(horizontal: 124.h, vertical: 23.v),
        decoration: AppDecoration.outlineIndigoA
            .copyWith(borderRadius: BorderRadiusStyle.roundedBorder22),
        child: Column(
            mainAxisSize: MainAxisSize.min,
