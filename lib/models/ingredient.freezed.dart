...
mixin _$Ingredient {
  ...
  @JsonKey(fromJson: measuresFromJson)
  IngredientMeasure get measures => throw _privateConstructorUsedError;
...
abstract class $IngredientCopyWith<$Res> {
  ...
  $Res call(
      {int id,
      String nameClean,
      @JsonKey(fromJson: measuresFromJson) IngredientMeasure measures});

  $IngredientMeasureCopyWith<$Res> get measures;
}
...
class _$IngredientCopyWithImpl<$Res, $Val extends Ingredient>
  ...
  @pragma('vm:prefer-inline')
  $IngredientMeasureCopyWith<$Res> get measures {
    return $IngredientMeasureCopyWith<$Res>(_value.measures, (value) {
...
class _$IngredientImpl implements _Ingredient {
  const _$IngredientImpl(
      ...
      @JsonKey(fromJson: measuresFromJson) required this.measures});
  ...
  @override
  @JsonKey(fromJson: measuresFromJson)
  final IngredientMeasure measures;

  @override
  String toString() {
    return 'Ingredient(id: $id, nameClean: $nameClean, measures: $measures)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, nameClean, measures);
...
abstract class _Ingredient implements Ingredient {
  const factory _Ingredient(
      ...
      @JsonKey(fromJson: measuresFromJson)
      required final IngredientMeasure measures}) = _$IngredientImpl;
  ...
  @override
  @JsonKey(fromJson: measuresFromJson)
  IngredientMeasure get measures;
  @override
  @JsonKey(ignore: true)
  _$$IngredientImplCopyWith<_$IngredientImpl> get copyWith =>
      throw _privateConstructorUsedError;
